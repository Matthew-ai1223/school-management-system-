...
<head>
    ...
    <title>School Payment - ACE Model College</title>
            ...
            <div class="col-lg-8 col-md-10">
                <div class="payment-card">
                    <div class="card-header">
                        ...
                        <p class="mb-0">Tuition fees, examination fees, and other school-related payments</p>
                    </div>
                    <div class="card-body p-4">
                            ...
                            <div class="account-info">
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <p class="h5 text-primary"><?php echo SCHOOL_ACCOUNT_NUMBER; ?></p>
                                    </div>
                                    <div class="col-md-6">
                                        <strong><i class="fas fa-user me-2"></i>Account Name:</strong>
                                        <p class="h5 text-primary"><?php echo SCHOOL_ACCOUNT_NAME; ?></p>
                                    </div>
                                </div>
                                <div class="row mt-3">
                                    <div class="col-md-6">
                                        <strong><i class="fas fa-building me-2"></i>Bank:</strong>
                                        <p class="h5 text-primary"><?php echo SCHOOL_BANK; ?></p>
                                    </div>
                                    <div class="col-md-6">
                        ...
                        <div class="text-center mt-4">
                            <a href="verify_payment.php?type=school" class="btn btn-verify btn-lg">
